...
#define PARAM_WORLD_SIZE_Y              2      //количество чанков в мире по вертикали (оси Y)
#define PARAM_CHUNK_SIZE                16      //Количество кубов, помещающихся в один чанк по x и z
#define PARAM_CHUNK_HEIGHT              16      //Количество кубов, помещающихся в один чанк по вертикали
